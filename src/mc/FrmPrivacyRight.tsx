    ...
    return (
        <div className={styles.main}>
            ...
            <div className={styles.isNode}><h1><span>隐私协议</span></h1>
                ...
                <p><span>更新时间：2022-06-28</span></p>
                <p><span>本协议适用于我公司旗下的4PL管家系列产品。</span></p>
                <p><span>恒凯昌（深圳）数字供应链有限公司（“深圳恒凯昌”或“我们”）以及4PL管家App（“本App”）深知个人信息对您的重要性，并会尽全力保护您的个人信息安全可靠。</span></p>
                ...
                <p><span>本声明的全部条款属于《4PL管家用户协议》的重要组成部分之一。一旦您浏览访问4PL管家App或者选择同意注册用户使用4PL管家的服务，即表示您已全面阅读，知悉本声明的内容，并同意做出相应的授权。本声明在您使用网站和服务的整个过程中有效，如果您对本声明有任何疑问、意见或建议，您可联系我们咨询反馈。如果您不同意本声明，您应立即停止使用4PL管家所提供的产品和服务。</span>
                </p>
                ...
                <p><span>7、适用范围</span></p>
                <p><span>8、本政策如何更新</span></p>
                <p><span>9、联系方式</span></p>

                <h2><span>1、定义</span></h2>
                <p><span>1.1</span></p>
                <p><span>“4PL管家”或“我们”:除非另有特别说明，在本政策中指恒凯昌（深圳）数字供应链有限公司。</span></p>
                <p><span>1.2</span></p>
                ...
                <p><span>2.1 帮助您注册成为4PL管家用户</span></p>
                <p><span>为助您成为4PL管家用户，以便我们为您提供注册用户服务（例如成为注册用户后即可登录个人中心查看各类信息，或有资格参与优惠政策等用户活动），您将通过4PL管家中的注册页面注册帐号。您在注册帐号的过程中，您会向我们直接提供手机号码、您设定的密码（加密）、手机验证码之个人敏感信息，您提供的手机号码在注册成功后将作为您之后登录我们服务的登录帐号，并且我们使用手机号码这类个人信息发送验证码信息以供您提交验证身份是否有效以及进行密码找回。</span>
                </p>
                ...
                <p><span>如果您已经登录了自己的4PL管家帐号，则您可以在登录帐号后向我们提供并完善您的昵称、联系地址、QQ 号、个人网址信息，您可选择拒绝提供该类信息，这不影响您正常使用4PL管家注册用户功能，如果您选择提供，我们均视为可关联的个人信息予以保护。</span>
                </p>
                <p><span>我们亦友情提示您，即使您不向我们提供任何个人信息，您也能够完全浏览我们官方网站的所有公开信息。</span></p>
                <p><span>2.2 为您提供4PL管家技术服务</span></p>
                <p><span>2.2.1</span></p>
                <p><span>您直接向我们提供的信息</span></p>
                <p><span>为向您提供我们的基础核心技术服务（包括对象存储、云主机、云数据库、CDN、内容审核等，具体请详见4PL管家官方网站所实时展示的服务内容），我们向您提供了多种实名认证形式。</span></p>
                <p><span>您应当知悉，4PL管家各类技术服务均属于我们的基础核心业务功能，如果您不提供上述列示的个人信息并通过实名认证，您将无法享受我们提供的基础核心技术服务。</span></p>
                <p><span>2.2.2</span></p>
                ...
                <p><span>我们所收集的个人信息将用于确保我们产品和服务的安全性和可靠性，并防范网络欺诈、网络攻击和入侵等，更准确地识别违反法律法规或4PL管家相关协议规则的情况。我们可能使用或整合您的帐号信息、设备信息、软件使用信息或依据法律共享的信息，用于进行身份验证、检测及防范安全事件，并依法采取必要的记录、审计、分析、处置措施。</span>
                </p>
                <p><span>2.6 征得您授权同意的例外</span></p>
                ...
                <p><span>2.6.10</span></p>
                <p><span>法律法规或相关规范规定的其他情形。</span></p>

                <h2><span>3、我们如何使用 Cookie 和同类技术</span></h2>
                <p><span>3.1 Cookie</span></p>
                <p><span>为确保4PL管家正常运转、为您获得更轻松的访问体验，我们会在您的计算机或移动设备上存储名为 Cookie 的小数据文件。Cookie 通常包含标识符、站点名称以及一些号码和字符。例如，借助于 Cookie，网站及客户端能够存储您的注册帐号、邮箱、密码（加密）和偏好等数据，Cookie 还可以帮助我们统计流量信息，分析页面设计。</span>
                </p>
                <p><span>4PL管家启用 Cookie 的目的与大多数网站或互联网服务提供商启用 Cookie 的目的一样，即改善用户体验。我们不会将 Cookie 用于本政策所述目的之外的任何用途。您可根据自己的偏好管理或删除 Cookie。您可以通过各类不同浏览器自带的功能清除设备上保存的所有 Cookie，但如果您这么做，则需要在每一次使用4PL管家时亲自更改用户设置。您可通过自行修改您设备浏览器设置的方式拒绝或管理 Cookie。</span>
                </p>
                ...
                <p><span>4.1.2</span></p>
                <p><span>在法定情形下的共享：我们可能会根据法律法规规定、诉讼争议解决需要，或按行政、司法机关依法提出的要求，对外共享披露您的个人信息。例如，如果我们确定您出现违反法律法规或严重违反4PL管家相关协议规则的情况，或为保护4PL管家及其关联公司用户或公众的人身财产安全免遭侵害，我们可能依据法律法规或平台相关协议规则披露关于您的个人信息，包括相关违规行为以及4PL管家平台已对您采取的措施。例如，若您使用的帐号或对您用户上传非法视频、违规视频等任何内容而严重违反我方平台规则、触犯法律法规和/或违背公序良俗，造成重大社会影响，给我方平台造成声誉损失，我们可能会公开披露您的信息与处罚情况。</span>
                </p>
                ...
                <p><span>5.2.2</span></p>
                <p><span>我们只允许那些为了帮我们处理个人信息而需要知晓这些信息的4PL管家员工、授权代为处理的服务公司的人员访问个人信息，而且他们需要履行严格的合同保密义务，且适时进行相关安全培训，如果其未能履行这些义务，就可能会被追究法律责任或被终止其与4PL管家的关系。</span>
                </p>
                <p><span>5.2.3</span></p>
                ...
                <p><span>您在使用4PL管家期间，我们将持续为您保存您的个人信息，但相关信息将以实现目的所必需的最小化时间进行保存，否则，我们将对个人信息进行源数据及备份数据的删除或匿名化处理。如果您注销帐号或主动删除上述信息，4PL管家将依据网络安全法等法律法规规定在您删除后 6 个月内继续保存您的信息。</span>
                </p>
                <p><span>4PL管家会按照法律法规的规定，将在境内运营过程中收集和产生的个人信息存储于中华人民共和国境内，且不会将该等信息向境外进行传输。如4PL管家因业务发展需要，需向境外进行传输的，将明确告知并征得您的同意。</span>
                </p>
                <h2><span>6、您的权利</span></h2>
                <p><span>6.1 个人信息访问权</span></p>
                <p><span>您有权访问您的个人信息，但法律法规规定的例外情况除外。如果您想行使数据访问权，可以在4PL管家网站来登录您的帐号。具体而言，您可以通过在4PL管家“个人面板-个人信息”访问您帐号下的信息内容。</span></p>
                <p><span>6.2 个人信息更正权</span></p>
                <p><span>当您发现我们处理的关于您的个人信息有错误时，您有权要求我们做出更正或自行通过登录帐号更正，通过在4PL管家“个人面板-个人信息/安全设置”更改您的个人信息。在更新您的个人信息时，我们可能会要求您先验证自己的身份（如向您电子邮箱或手机号码发送验证信息），然后再处理您的请求。</span>
                </p>
                ...
                <p><span>在您的帐号内无资源、无任何未支付的费用、无争议纠纷时，您可通过提交工单注销帐号。请注意，您注销帐号的行为是不可逆的行为，在注销帐号之后，您将无法通过已注销的帐号获得4PL管家商城提供产品或服务，我们将会在15个工作日内删除或匿名化有关您帐号的一切信息，发送邮件通知您，并保证这些信息不会泄露，但法律法规另有规定要求保存的数据除外。</span>
                </p>
                ...
                <p><span>如果4PL管家终止服务或运营，我们将及时停止收集您个人信息的活动，并且会至少提前三十日将停止运营的通知以逐一送达或公告的形式通知您，并在终止服务或运营后对所持有的您的个人信息进行删除或匿名化处理。</span></p>
                <h2><span>7、适用范围</span></h2>
                <p><span>为确保流畅的4PL管家使用体验，您可能会收到来自第三方提供的内容或网络链接。我们对此类第三方无控制权。您可选择是否访问第三方提供的链接、内容、产品和服务。我们无法控制第三方的隐私和数据保护政策，此类第三方不受到本政策的约束。在向第三方提交个人信息之前，请参见这些第三方的隐私保护政策。</span>
                </p>
                <h2><span>8、本政策如何更新</span></h2>
                ...
                <h2><span>9、联系方式</span></h2>
                <p><span>客服电子邮件：plc-cn@139.com</span></p>
                <p><span>您对4PL管家及本隐私权政策有任何疑惑、意见或建议，您可通过拨打客服热线的方式来取得我们的联系。</span></p>
