...
type PayeePopup_MCTypeProps = {
    onSelect: Function
} & BasePopupTypeProps

export class PayeePopup_MC extends BasePopup<PayeePopup_MCTypeProps, PayeePopupTypeState> {
    constructor(props: PayeePopup_MCTypeProps) {
        super(props);
        let dataRow = new DataRow();
        dataRow.setValue('MaxRecord_', -1);
        this.state = {
    ...
    content(): JSX.Element {
        return <div className={styles.main}>
            ...
            <ul className={styles.inputLine}>
                <li>
                    <PopupEdit dataRow={this.state.dataRow} dataField='payee_name_' class={styles.nameInput} placeHolder='请输入姓名' onChange={this.handleChange.bind(this)} autoFocus={true}></PopupEdit>
                </li>
                <li>
                    <PopupEdit type="number" dataRow={this.state.dataRow} dataField='phone_number_' class={styles.mobileInput} placeHolder='请输入手机号' onChange={this.handleChange.bind(this)}></PopupEdit>
                </li>
            </ul>
            <div className={styles.buttonLine}>
                <button onClick={this.handleSubmit.bind(this, this.state.dataRow)}>确定</button>
