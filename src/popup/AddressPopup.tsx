...
type AddressPopup_MCTypeProps = {
    onSelect: Function
} & BasePopupTypeProps

export class AddressPopup_MC extends BasePopup<AddressPopup_MCTypeProps, AddressPopupTypeState> {
    constructor(props: AddressPopup_MCTypeProps) {
        super(props);
        let dataRow = new DataRow();
        dataRow.setValue('maxRecord', -1);
        this.state = {
    ...
    content(): JSX.Element {
        return <div className={styles.main}>
            ...
            <ul className={styles.inputLine}>
                <li>
                    <PopupEdit dataRow={this.state.dataRow} dataField='contact_' class={styles.nameInput} placeHolder='请输入姓名' onChange={this.handleChange.bind(this)} autoFocus={true}></PopupEdit>
                </li>
                <li>
