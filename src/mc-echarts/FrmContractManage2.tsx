...
import styles from "./FrmContractManage2.css";
...
export default class FrmContractManage2 extends WebControl<FrmContractManage2TypeProps, FrmContractManage2TypeState> {
    constructor(props: FrmContractManage2TypeProps) {
        super(props);
                ...
                <div className={styles.mcFlowChartBox}>
                    ...
                    <div className={styles.mcFlowChartMain}>
                        ...
                        <div className={styles.mcFlowBox}>
                            ...
                            <div className={`${this.state.dataRow.getBoolean(`应付对账单_Dis`) ? styles.receipt_disable : styles.receipt} ${styles.stock11}`} onClick={this.linkTo.bind(this, '应付对账单')}>
                                <span>应付对账单</span>
                            </div>
                        </div>
                    </div>
