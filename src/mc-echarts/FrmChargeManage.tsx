...
export default class FrmChargeManage extends WebControl<FrmChargeManageTypeProps, FrmChargeManageTypeState> {
    constructor(props: FrmChargeManageTypeProps) {
        ...
        let dataRow: DataRow = lineRow.setValue("费用请购单_URL", "")
            .setValue("费用请购单_Dis", true)
            .setValue("费用报销单_URL", "")
            .setValue("费用报销单_Dis", true)
            .setValue("费用进货单_URL", "")
            .setValue("费用进货单_Dis", true)
            .setValue("付款(申请)单_URL", "")
            .setValue("付款(申请)单_Dis", true)
            .setValue("报废单_URL", "")
            .setValue("报废单_Dis", true)
            .setValue("办公用品库存表_URL", "")
            .setValue("办公用品库存表_Dis", true)
            .setValue("会计凭证_URL", "TFrmAccBook")
            .setValue("会计凭证_Dis", false)
            .setValue("还库单_URL", "")
            .setValue("还库单_Dis", true)
            .setValue("领用单_URL", "")
            .setValue("领用单_Dis", true)
            .setValue("个人领用报表_URL", "")
            .setValue("个人领用报表_Dis", true);
