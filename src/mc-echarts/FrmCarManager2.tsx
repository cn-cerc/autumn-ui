...
import styles from "./FrmCarManager2.css";
import { MCChartColors } from "./FrmTaurusMC";

type FrmCarManager2TypeProps = {

}

type FrmCarManager2TypeState = {
    dataRow: DataRow,
...
//车辆管理控制台 货主
export default class FrmCarManager2 extends WebControl<FrmCarManager2TypeProps, FrmCarManager2TypeState> {
    constructor(props: FrmCarManager2TypeProps) {
        super(props);
