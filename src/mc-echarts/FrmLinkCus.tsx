...
export default class FrmLinkCus extends WebControl<
  FrmLinkCusTypeProps,
  FrmLinkCusTypeState
> {
          ...
          <div className={styles.mcFlowChartBox}>
            ...
            <div className={styles.mcFlowChartMain}>
              ...
              <div className={styles.mcFlowBox}>
                <div
                  className={`${
                    this.state.dataRow.getBoolean(`审核客户接入_Dis`)
                      ? styles.other_disable
                      : styles.other
                  } ${styles.stock2}`}
                  onClick={this.linkTo.bind(this, "审核客户接入")}
                >
                  <span>审核客户接入</span>
                </div>
                <div
                  className={`${
                    this.state.dataRow.getBoolean(`连接客户申请_Dis`)
                      ? styles.other_disable
                      : styles.other
                  } ${styles.stock4}`}
                  onClick={this.linkTo.bind(this, "连接客户申请")}
                >
                  <span>连接客户申请</span>
                </div>
                <div
                  className={`${
                    this.state.dataRow.getBoolean(`下游互联管理_Dis`)
                      ? styles.control_disable
                      : styles.control
                  } ${styles.stock5}`}
                  onClick={this.linkTo.bind(this, "下游互联管理")}
                >
                  <span>下游互联管理</span>
                </div>
                <div
                  className={`${
                    this.state.dataRow.getBoolean(`库存与销售统计_Dis`)
                      ? styles.control_disable
                      : styles.control
                  } ${styles.stock6}`}
                  onClick={this.linkTo.bind(this, "库存与销售统计")}
                >
                  <span>库存与销售统计</span>
                </div>
                <div
                  className={`${
                    this.state.dataRow.getBoolean(`接入权限设置_Dis`)
                      ? styles.other_disable
                      : styles.other
                  } ${styles.stock7}`}
                  onClick={this.linkTo.bind(this, "接入权限设置")}
                >
                  <span>接入权限设置</span>
                </div>
                <div
                  className={`${
                    this.state.dataRow.getBoolean(`线上订单确认_Dis`)
                      ? styles.other_disable
                      : styles.other
                  } ${styles.stock8}`}
                  onClick={this.linkTo.bind(this, "线上订单确认")}
                >
                  <span>线上订单确认</span>
                </div>
              </div>
