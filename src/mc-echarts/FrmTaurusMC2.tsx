...
export default class FrmTaurusMC2 extends WebControl<FrmTaurusMCTypeProps, FrmTaurusMCTypeState> {
    constructor(props: FrmTaurusMCTypeProps) {
        ...
        linkRow.setValue("商品资料登记_URL", "FrmCodeRecord")
            ...
            .setValue("货主线上委托_URL", "FrmCargoOrderEntrust.acceptedList?sourcePage=FrmTaurusMC2")
            .setValue("货主线上委托_Dis", false)
            .setValue("货主线下委托_URL", "")
            .setValue("货主线下委托_Dis", true)
            ...
            .setValue("委托第三方物流运输_URL", "FrmCargoOrderEntrust.applyList?sourcePage=FrmTaurusMC2")
        ...
        this.state = {
            ...
            introduction: '货主线上/线下委托货运，接收/登记物流订单后，可以选择运输模式运输货物。可以事先设置好商品资料登记、客户登记、以及车队与司机登记，以方便节省大量的重复的信息输入情况。可以对所有的物流订单进行管理和监控，查看货运相关数据统计以及数据分析。'
        }
    }
