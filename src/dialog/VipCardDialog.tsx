import { BaseDialog, BaseDialogStateType, Column, ColumnIt, DataRow, DataSet, DBDrop, DBEdit, DBGrid, SearchPanel } from "autumn-ui";
...
export default class VipCardDialog extends BaseDialog<VipCardTypeProps, VipCardTypeState> {
    ...
    async getVipCardInfo(): Promise<DataSet> {
        this.setLoad(true);
        let dataSet = await DitengApi.getVipCardInfo(this.state.dataIn);
        this.setLoad(false);
        return dataSet;
    }
