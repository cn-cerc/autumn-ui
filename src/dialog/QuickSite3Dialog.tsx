...
export default class QuickSiteDialog3 extends BaseDialog<QuickSiteDialogTypeProps, QuickSiteDialogTypeState> {
    ...
    handleClick() {
        ...
        if (this.state.site.township)
            siteValue += `\\${this.state.site.township}`;
