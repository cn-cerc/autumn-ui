...
type ExpenseTypeState = {
    dataIn: DataRow,
    dataSet: DataSet
} & Partial<BaseDialogStateType>

export default class ExpenseDialog extends BaseDialog<BaseDialogPropsType, ExpenseTypeState> {
    ...
    async init() {
        this.setLoad(true);
        let dataSet = await DitengApi.getExpense(this.state.dataIn);
        this.setLoad(false);
        this.setState({
            dataSet
        })
