import { BaseDialog, BaseDialogPropsType, BaseDialogStateType, Column, DataRow, DataSet, DBCheckbox, DBDrop, DBEdit, DBGrid, SearchPanel } from "autumn-ui";
...
export default class SupDialog extends BaseDialog<BaseDialogPropsType, SupTypeState> {
    ...
    async init() {
        this.setLoad(true);
        let dataSet = await DitengApi.getSupInfo(this.state.dataIn);
        this.setLoad(false);
        this.setState({
            dataSet
        })
