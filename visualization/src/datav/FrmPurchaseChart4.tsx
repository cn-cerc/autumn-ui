...
export default class FrmSaleChart extends React.Component<PropsType, stateType> {
    ...
    initLineChart(option?: any) {
        ...
        let purchaseLenged1 = ['螺纹钢2021年', '螺纹钢2022年', '螺纹钢2022年目标', '型钢2021年', '型钢2022年', '型钢2022年目标', '带钢2021年', '带钢2022年', '带钢2022年目标'];
        let purchaseLenged2 = ['线材2021年', '线材2022年', '线材2022年目标', '板材2021年', '板材2022年', '板材2022年目标', '管材2021年', '管材2022年', '管材2022年目标'];
        let purchaseDataArr1: any = [
            [4.3, 2.5, 3.5, 4.5, 5, 6, 7, 8, 3, 6, 4, 9],
            [2.4, 4.4, 1.8, 2.8],
            [6, 2.1, 6, 9, 3, 6.9, 4.9, 11, 9, 10, 9.5, 10.9],
            [2.8, 1, 9, 1, 2.5, 5, 3.5, 4.3, 9, 7, 4, 5],
            [1, 3, 8, 7, 8, 2.9, 3.7, 9, 9, 10, 11, 10.5],
            [2, 3.6, 5, 2, 8.3, 9, 4, 9, 5.1, 10.5, 9, 10.5],
            [6, 7.4, 2, 3, 4.8, 9, 9, 9, 9, 10, 10.5, 10.1],
            [8, 8.5, 6, 7, 3.7, 3, 6, 9, 2, 10, 8.8, 11],
        ...
        let purchaseDataArr2: any = [
            ...
            [2.6, 1, 6, 1, 2.5, 5, 4.5, 4.3, 9, 7, 4, 5],
            [1, 3, 6, 7, 8, 2.9, 2.7, 9, 9, 5, 6, 7],
            [2, 6, 5, 2, 8.3, 8.9, 3, 9, 5.1, 10.5, 9, 10.5],
            [6, 4, 2, 3, 4.8, 7.9, 5, 9, 9, 10, 5, 3],
            [8, 5, 6, 7, 3.7, 3.8, 4.6, 9, 2, 7, 4.8, 6],
            [9, 6.6, 6.8, 4, 6.8, 7, 9, 6.7, 5.9, 6.8, 8.9, 10]
        ];
        let purchaseLenged, purchaseDataArr;
        if (this.state.pageType1 == 1) {
        ...
        for (let i = 0; i < purchaseLenged.length; i++) {
            var type:string = 'solid',width:number = 4,color = lineColir[2];
            if(i == 0 || i == 3 || i == 6){
                type = 'dashed';
                color = lineColir[0];
            }
