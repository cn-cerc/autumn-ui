...
export default class SaleDetail3 extends React.Component<FrmReportTypeProps, FrmReportTypeState> {
    ...
    render(): React.ReactNode {
        ...
        return <React.Fragment>
            ...
            <ReportDetail dataSet={this.state.reportData} head={this.state.reportHead} title={`${this.state.reportName}本年${this.state.showOut ? '出货' : '接单'}动态（${year}年）`} key={String(this.state.showOut)} backHref='FrmPurchaseChart4' backTitle='采购数据管理中心'></ReportDetail>
        </React.Fragment>
    }
