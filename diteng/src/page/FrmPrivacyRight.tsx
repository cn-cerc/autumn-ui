    ...
    return (
        <div className={styles.main}>
            ...
            <div className={styles.isNode}><h1><span>隐私协议</span></h1>
                ...
                <p><span>本声明的全部条款属于《地藤用户协议》的重要组成部分之一。一旦您浏览访问地藤App 或者选择同意注册用户使用地藤的服务，即表示您已全面阅读，知悉本声明的内容，并同意做出相应的授权。本声明在您使用网站和服务的整个过程中有效，如果您对本声明有任何疑问、意见或建议，您可联系我们咨询反馈。如果您不同意本声明，您应立即停止使用地藤所提供的产品和服务。</span>
                </p>
                ...
                <p><span>为助您成为地藤用户，以便我们为您提供注册用户服务（例如成为注册用户后即可登陆个人中心查看各类信息，或有资格参与优惠政策等用户活动），您将通过地藤中的注册页面注册帐号。您在注册帐号的过程中，您会向我们直接提供电子邮箱地址、手机号码、您设定的帐号密码（加密）、手机验证码之个人敏感信息，您提供的电子邮箱在注册成功后将作为您之后登陆我们服务的登录帐号，并且我们使用电子邮箱地址、手机号码这类个人信息发送验证码信息以供您提交验证身份是否有效以及进行密码找回。</span>
                </p>
                ...
                <p><span>如果您已经登录了自己的地藤帐号，则您可以在登陆帐号后向我们提供并完善您的昵称、联系地址、QQ 号、个人网址信息，您可选择拒绝提供该类信息，这不影响您正常使用地藤注册用户功能，如果您选择提供，我们均视为可关联的个人信息予以保护。</span>
                </p>
                ...
                <p><span>为向您提供安全稳定的服务、保障您的账户财产安全、预防冒名登陆，我们需要记录您的设备型号、IP 地址、设备软件版本信息、设备识别码。如果您不同意我们记录前述信息，可能无法完成风控验证，而无法使用我们的软件。</span>
                </p>
                ...
                <ul>
                    ...
                    <li>开启护眼模式：您在开启护眼模式后会添加护眼模式的悬浮窗，并需要获取您的进程列表保证悬浮窗的状态。</li>
                </ul>
                ...
                <p><span>我们通过此类信息综合判断地藤的某一产品、解决方案或功能设置的必要性，可能会请用户参与各类反馈、互动以便推出新的产品和服务（例如和公司业务联系人手机、电子邮件沟通等），为了改善我们的产品或服务，在取得您同意的情况下，我们可能将您的个人信息与第三方数据匹配形成间接用户画像，以便我们进行产品研发或者有针对性地（通过邮寄、电子邮件、电话）向您提供服务信息。您也可通过联系地藤客服的方式告诉我们，我们将不再收集您的信息用于以上场景，这不会影响您正常使用地藤的核心技术功能。</span>
                </p>
                ...
                <p><span>4.1.2</span></p>
                <p><span>关联公司：您的个人信息可能会与地藤的关联公司共享。我们只会共享必要的个人信息，且受本隐私权政策中所声明目的的约束。关联公司如要改变个人信息的处理目的，将再次征求您的授权同意。</span></p>
                <p><span>4.1.3</span></p>
                ...
                <p><span>为实现广告推送，与广告、统计分析类合作伙伴的共享。地藤仅会向这些合作伙伴提供无法识别您个人身份信息的用户画像标签及去标识化或匿名化后的统计类信息，以帮助其在不识别您个人身份的前提下提升广告有效触达率。除非得到您的许可，否则我们不会将您的个人身份信息（指可以识别您身份的信息，例如姓名或手机号码，通过这些信息可以联系到您或识别您的身份）与提供广告、分析服务的合作伙伴共享。</span>
                </p>
                ...
                <p><span>当您发现我们处理的关于您的个人信息有错误时，您有权要求我们做出更正或自行通过登陆帐号更正，通过在地藤“个人面板-个人信息/安全设置”更改您的个人信息。在更新您的个人信息时，我们可能会要求您先验证自己的身份（如向您电子邮箱或手机号码发送验证信息），然后再处理您的请求。</span>
                </p>
                ...
                <p>
                    <span>当您有其他的投诉、建议或相关问题时，请通过本政策的联系方式与地藤公司联系。我们将尽快审核所涉问题，并在验证您的用户身份后及时予以回复，一般在三十天内作出答复。当然，如您不满意，您也可以通过向主管机关提出投诉举报。</span>
                </p>
                ...
                <p><span>您应当清楚无误地知悉，本隐私权政策不适用于其他第三方向您提供的服务，例如，地藤云市场上的服务商（例如直播服务商）依托地藤向您提供服务时，您向该类服务商提供的信息不适用本隐私权政策。我们也建议利用我们云服务而再向您用户提供服务的企业用户，应当另行与您的用户约定隐私权政策。</span>
                </p>
                ...
                <h2><span>11、第三方SDK说明</span></h2>
                <p><span>11.1、极光推送</span></p>
                <p><span>为保障我们我们及时推送某部分通知或订阅消息到用户，我们采用极光推送SDK实现此功能，该SDK可能存在但不仅限于软件安装列表等私密信息。</span></p>
            </div>
        </div>
    )
}
