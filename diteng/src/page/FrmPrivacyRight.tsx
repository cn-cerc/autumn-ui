    ...
    return (
        <div className={styles.main}>
            ...
            <div className={styles.isNode}><h1><span>隐私协议</span></h1>
                ...
                <p><span>当您通过地藤管家与我们或其他用户进行通信、反馈、分享等互动时，我们将收集并使用您提交的姓名（昵称）、手机号码、电子邮箱地址等联系信息。</span>
                </p>
                ...
                <p><span>2.3 软件安装列表;</span></p>
                <p><span>在您使用地藤管家过程中，我们使用第三方SDK极光推送实施实时推送的功能，此功能可能或获取部分敏感信息，包含且不仅限于软件安装列表等</span>
                </p>
                ...
                <p><span>为确保地藤管家正常运转、为您获得更轻松的访问体验，我们会在您的计算机或移动设备上存储名为 Cookie 的小数据文件。Cookie 通常包含标识符、站点名称以及一些号码和字符。例如，借助于 Cookie，网站及客户端能够存储您的注册帐号、邮箱、密码（加密）和偏好等数据，Cookie 还可以帮助我们统计流量信息，分析页面设计。</span>
                </p>
