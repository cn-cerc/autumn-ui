                ...
                <React.Fragment>
                    <form method="post" className={styles.mainBox} onSubmit={this.onSubmit.bind(this)}>
                        <div className={`${styles.inputGroup} ${styles.userName} ${this.state.iconHover == 1 ? styles.inputHover : ''}`}>
                            <img src={this.state.iconHover == 1 ? StaticPath.getImage('images/login/account_hover.png') : StaticPath.getImage('images/login/account.png')} />
                        ...
                        <div className={`${styles.inputGroup} ${styles.passWord} ${showVerify ? '' : styles.noBottomMargin} ${this.state.iconHover == 2 ? styles.inputHover : ''}`}>
                            <img src={this.state.iconHover == 2 ? StaticPath.getImage('images/login/password_hover.png') : StaticPath.getImage('images/login/password.png')} />
                        ...
                        <div className={styles.operationLogin}>
                            <img src={this.state.savePwd ? StaticPath.getImage('images/icon/checkbox_checked.png') : StaticPath.getImage('images/icon/checkbox.png')} onClick={this.changeSvaePwd.bind(this)}></img>
                        ...
                        <section className={styles.customService}>
                            <div className={styles.protocolBox}>
                                <div className={styles.protocol}>
                                    <img src={this.state.protocol ? StaticPath.getImage('images/icon/checkbox_checked.png') : StaticPath.getImage('images/icon/checkbox.png')} onClick={this.changeProtocol.bind(this)}></img>
            ...
            if (this.isPhone) {
                return (
                    <div className={`${styles.inputGroup} ${styles.verify} ${this.state.iconHover == 3 ? styles.inputHover : ''}`}>
                        <img src={this.state.iconHover == 3 ? StaticPath.getImage('images/login/verify_hover.png') : StaticPath.getImage('images/login/verify.png')} />
            ...
            return (
                <React.Fragment>
                    <div className={styles.logoBox}>
                        <img src={StaticPath.getImage('images/login/logo_phone.png')} />
                        <h3>您好！欢迎登录地藤管家！</h3>
                    </div>
                    ...
                    <div className={styles.upt}>
                        <div>
                            <img className={styles.backImg} src={StaticPath.getImage('images/forgetPwd/关闭.png')} />
                        ...
                        <div className={styles.loginFormBox}>
                            <div className={styles.loginLeft}>
                                <div className={styles.loginLogo}>
                                    <img src={StaticPath.getImage('images/login/logo.png')} alt="地藤管家" />
                                    <span>地藤管家</span>
                                </div>
